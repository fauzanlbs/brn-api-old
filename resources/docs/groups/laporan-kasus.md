...
```bash
curl -X GET \
    -G "http://api.brn.com/api/my-case-reports?search=Avansa&page[number]=1&page[size]=2&sort=created_at&include=voluptas&filter[status]=pending&filter[request_delete]=1&filter[created_at]=2020-12-24" \
...
curl -X POST \
    ...
    -d '{"car_id":1,"location":"31.2467601,29.9020376","chronology":"nostrum","perpetrator":{"nik":123123123,"name":"Arya Anggara","phone_number":"0821123213","address":"Jl. Letkol Basir Surya No.71, Tasimalaya, Jawa barat, Indonesia","photo":"path","information":"ratione"}}'
