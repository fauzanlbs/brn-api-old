...
class AgendaController extends Controller
{
    ...
    public function qrScan(Request $request, Agenda $agenda)
    {
        ...
        if ($absentExists) {
            return response()->json(['id' => $agenda->id, 'message' => 'Anda sudah masuk sebelumnya!', 'status' => 'notice'], 400);
        }
        ...
        return response()->json(['id' => $agenda->id, 'message' => 'Berhasil absen ke agenda!', 'status' => 'ok'], 200);
    }
